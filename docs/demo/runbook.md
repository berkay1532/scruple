...
- Webhook management is live via the service's `/admin/*` API (endpoint CRUD, pause/resume, secret rotate, deliveries inspector with Resend); dashboard Webhooks screen wiring lands next.
